...
const contents = [
    ...
    {isUpload: false, content: `Completing these 4 steps should take less than 30 minutes in total, and you're already well on your way. Once you're done and your recordings are uploaded, we train our AI to match your voice. This might take a few hours, but sometimes even as little as 15 minutes, depending on how many other people are doing it.`},
    {isUpload: false, content: `Once your voice clone is ready, you can use your voice clone by using song conversion credits. We've given you 3 credits right away, just for cloning your voice. If you need more, we offer subscriptions and pay-as-you-go options. Each credit lasts forever and can be used for songs up to 10 minutes long.`},
